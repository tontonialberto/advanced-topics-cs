...
class Consensus(GroupPrediction):
    def __init__(self, group_predictor: GroupPrediction, disagreement: Disagreement, weight_disagreement: float) -> None:
        self.__group_predictor = group_predictor
        self.__disagreement = disagreement
        self.__weight_prediction = 1 - weight_disagreement
